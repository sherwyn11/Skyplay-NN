...
def propagate_backward(AL, Y, caches, regularization_type, regularization_rate, activations):
    ...
    for l in reversed(range(L-1)):
        ...
        dA_prev_temp, dW_temp, db_temp = linear_activation_backward(grads['dA' + str(l + 2)], current_cache, activations['Activation' + str(l + 2)], regularization_type, regularization_rate)
